...
UPLOAD_URL="https://api.bintray.com/content/openobservatory/deb/ooniprobe/${VERSION}/${FILE_TARGET_PATH};deb_distribution=$DEB_DISTRIBUTIONS;deb_component=main;deb_architecture=$DEB_ARCHITECTURE"
